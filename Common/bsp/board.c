...
#define SYS_BOARD_MCKR      (PMC_MCKR_PRES_CLK_1 | PMC_MCKR_CSS_PLLA_CLK | SYS_BOARD_MCKR_MDIV)
...
void SystemInit(void)
{
    ...
    */
	...
	/* Switch to main clock: DO NOT modify MDIV and CSS field at the same access */
